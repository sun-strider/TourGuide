...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView numbers = (TextView) findViewById(R.id.hotels);
        ...
        TextView colors = (TextView) findViewById(R.id.sights);
        ...
        colors.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent colorsIntent = new Intent(MainActivity.this, SightsActivity.class);
                startActivity(colorsIntent);
            }
        });

        // Find the View that shows the events category
        TextView phrases = (TextView) findViewById(R.id.events);
